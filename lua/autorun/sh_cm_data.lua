...
CMWeapons["weapon_hl2_357"] = { -- T4 Pistol
	Weight = 4,
	Slot = 2,
	Rank = 35,
	}
	
CMWeapons["weapon_hl2_ar2"] = { -- T4 Rifle
	Weight = 7,
	Slot = 4,
	Rank = 45,
	}	

CMWeapons["weapon_hl2_c4"] = { -- T3 Nade
	Weight = 3,
	Slot = 5,
	Rank = 30,
}	
	
CMWeapons["weapon_hl2_crossbow"] = { -- T4 Misc
	Weight = 8,
	Slot = 4,
	Rank = 55,
	}	
...
CMWeapons["weapon_hl2_pee"] = { -- T1 Misc
	Weight = 0,
	Slot = 0,
	Rank = 1,
}	
...
CMWeapons["weapon_hl2_rpg"] = { -- T4 Misc
	Weight = 10,
	Slot = 4,
	Rank = 55,
	}
...
CMWeapons["weapon_hl2_tesla"] = { -- T4 Nade
	Weight = 3,
	Slot = 5,
	Rank = 55,
}		
...
CMWeapons["weapon_ex_bishot"] = { -- T4 Sniper
	Weight = 9,
	Slot = 4,
	Rank = 50,
}
...
CMWeapons["weapon_ex_dildocannon"] = { -- T4 Misc
	Weight = 8,
	Slot = 4,
	Rank = 55,
}

CMWeapons["weapon_ex_energysword"] = { -- T4 Melee
	Weight = 10,
	Slot = 1,
	Rank = 35,
}

CMWeapons["weapon_ex_fal"] = { -- T3 Sniper
	Weight = 8,
	Slot = 4,
	Rank = 26,
}

CMWeapons["weapon_ex_m24"] = { -- T3 Sniper
	Weight = 8,
	Slot = 4,
	Rank = 26,
}

CMWeapons["weapon_ex_m76"] = { -- T3 Sniper
	Weight = 10,
	Slot = 4,
	Rank = 26,
}

CMWeapons["weapon_ex_m82"] = { -- T4 Sniper
	Weight = 15,
	Slot = 4,
	Rank = 50,
}
...
CMWeapons["weapon_ex_pistolx2"] = { -- T4 Pistol
	Weight = 8,
	Slot = 2,
	Rank = 35,
}	

CMWeapons["weapon_ex_plasmarifle"] = { -- T4 SMG
	Weight = 4,
	Slot = 3,
	Rank = 40,
}
...
CMWeapons["weapon_ex_sako"] = { -- T3 Sniper
	Weight = 9,
	Slot = 4,
	Rank = 26,
}
